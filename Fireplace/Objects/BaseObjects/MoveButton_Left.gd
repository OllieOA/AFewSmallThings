...
func _ready() -> void:
	outline_alert_level1_texture = load("res://Assets/UI/UIMovement_Left_Alert1.png")
	outline_alert_level2_texture = load("res://Assets/UI/UIMovement_Left_Alert2.png")
	self.connect("object_selected", self, "_move_select", ["Left"])
